variable "broker_service_account_id" {
  description = "Broker GSA fully-qualified name (projects/-/serviceAccounts/<email>); the WI binding uses this to authorise the region's broker KSA (bunshin/broker-asne1)"
  type        = string
