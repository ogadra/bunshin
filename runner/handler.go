...
var handlerAppFilePath = "/app/handler.pl"
...
// It reads /app/handler.pl and returns the current contents so the front
...
// It writes the raw request body to /app/handler.pl atomically (tmp + rename)
